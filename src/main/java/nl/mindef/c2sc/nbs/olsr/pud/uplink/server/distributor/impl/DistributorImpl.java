...
//
//	private DatagramPacket toPacket(Set<PositionUpdateMsg> packetPositions,
...
//		int dataPos = 0;
//		for (PositionUpdateMsg packetPosition : packetPositions) {
//			byte[] src = packetPosition.getPositionUpdateMsg().getData();
...
//			List<PositionUpdateMsg> positionsToDistribute) {
...
//
//		Set<PositionUpdateMsg> packetPositions = new HashSet<PositionUpdateMsg>();
//		int packetPositionsByteCount = 0;
//		for (PositionUpdateMsg positionToDistribute : positionsToDistribute) {
//			int msgLength = positionToDistribute.getPositionUpdateMsg().getData().length;
...
//				List<PositionUpdateMsg> p4ds = positions
...
//					Integer clusterLeaderDownlinkPort = clusterLeader
//							.getDownlinkPort();
//
//					if ((clusterLeaderIp == null)
//							|| (clusterLeaderDownlinkPort == null)) {
